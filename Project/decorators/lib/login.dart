          ...
          children: [
                ...
                children: [
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      prefixIcon: const Icon(Icons.email, color: Color(0xFFA49A9A)),
                      filled: true,
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      suffixIcon: const Icon(Icons.visibility, color: Color(0xFFA49A9A)),
                      filled: true,
                      fillColor: const Color(0xFFFDF7F2),
                      contentPadding: const EdgeInsets.symmetric(vertical: 16),
                      border: OutlineInputBorder(
            ...
            ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                backgroundColor: const Color(0xFFB3A1A1), // Muted pastel pink
            ...
            children: [
              ...
              ElevatedButton(
                onPressed: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => Decoreg()),
                  );
                },
                style: ElevatedButton.styleFrom(
              ...
              ElevatedButton(
                onPressed: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => CatReg()), // You create this page
                  );
                },
                style: ElevatedButton.styleFrom(
                  backgroundColor: const Color(0xFFB3A1A1),
